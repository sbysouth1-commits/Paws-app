    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.center}>
        <View style={[styles.iconWrap, kid && styles.iconWrapKid]}>
          <PawIcon size={44} color={kid ? colors.paper : colors.mauve} />
        </View>
...
const styles = StyleSheet.create({
  ...
  iconWrap: {
    ...
    height: 88,
    borderRadius: 28,
    backgroundColor: colors.mauveTint,
    alignItems: 'center',
    justifyContent: 'center',
    marginBottom: 4,
  },
  iconWrapKid: { backgroundColor: colors.purple },
  title: { fontFamily: fonts.heading, fontSize: 24, color: colors.purple, textAlign: 'center' },
